...
namespace ASRSystem.Data
{
    public static class SeedData
    {
        ...
        private static void InitialiseUsers(UserManager<User> userManager)
        {
            // Look for any users.
        ...
        private static void CreateUser(UserManager<User> userManager, string userName) =>
            userManager.CreateAsync(new User { UserName = userName, Email = userName }, "abc123").Wait();

        private static void InitialiseAsrData(AsrContext context, UserManager<User> userManager)
        {
            // Look for any rooms.
            if (context.Room.Any())
                return; // DB has been seeded.
